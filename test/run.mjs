...
import changeset from "./repo/query/changeset.suite.mjs";
...
const DOMAINS = [
  {
    ...
    suites: [bitmap, ordinal, facetIndex, serialization, database, querySpec, queryImages, queryTags, changeset, mutation, mutationValidation, hidden],
  },
  {
    name: "image",

...
import projection from "./repo/query/projection.suite.mjs";
...
const DOMAINS = [
  {
    ...
    suites: [bitmap, ordinal, facetIndex, serialization, database, querySpec, queryImages, queryTags, projection, mutation, mutationValidation, hidden],
  },
  {
    name: "image",
